# nohup snakemake -s source_functions/gwas_ww.gibbs.snakefile --keep-going --directory /home/agiintern/regions --rerun-incomplete --latency-wait 90 --resources load=120 -j 36 --config &> log/snakemake_log/gwas_ww.gibbs/201015.gwas_ww.gibbs.log &
...
rule target:
    input:
        targ = expand("data/derived_data/gwas_ww.gibbs/iter{iter}/{dataset}/solutions", iter = config['iter'], dataset = config['dataset'])
...
rule pull_genotypes:
    ...
    output:
        reduced_geno = "data/derived_data/gwas_ww.gibbs/iter{iter}/genotypes.iter{iter}.txt"
    shell:
        """
