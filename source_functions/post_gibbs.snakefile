# nohup snakemake -s source_functions/post_gibbs.snakefile --directory /home/agiintern/angus_regions --rerun-incomplete --latency-wait 90 --resources load=50 --config -R post_gibbs &> log/snakemake_log/post_gibbs/210225.post_gibbs.log &
